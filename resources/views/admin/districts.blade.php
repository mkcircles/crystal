    ...
    <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
        <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
            ...
            <div class="grid lg:grid-cols-2 mb-6">
                <div>
                    <h4 class="mb-1 text-xl font-semibold tracking-tight text-gray-900 dark:text-white group">Districts</h4>
                    <p class="text-md text-gray-500 lg:mb-0 dark:text-gray-400 lg:max-w-2xl">List of covered districts</p>
                </div>
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td class="px-4 py-3 flex items-center ">
                                <a href="{{route('district.show',['area'=>$district->district_name])}}" class="text-gray-500  hover:text-blue-400">Show Groups</a>
                            </td>
                        </tr>
                        @endforeach
